namespace Prequel
{
    ...
    public class ProgramTerminatingException : Exception, ISerializable
    {
        ...
        public ProgramTerminatingException(string message, ExitReason exitcode = ExitReason.GeneralFailure) 
            : base(message)
        {
            ExitCode = exitcode;
        }
        ...
        protected ProgramTerminatingException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
